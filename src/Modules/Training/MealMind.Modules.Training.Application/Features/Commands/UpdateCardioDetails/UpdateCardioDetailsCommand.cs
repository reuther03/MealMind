...
namespace MealMind.Modules.Training.Application.Features.Commands.UpdateCardioDetails;

public record UpdateCardioDetailsCommand(Guid PlanId, Guid SessionId, Guid ExerciseId, CardioDetails CardioDetails) : ICommand<bool>
{
    public sealed class Handler : ICommandHandler<UpdateCardioDetailsCommand, bool>
    {
        ...
        public async Task<Result<bool>> Handle(UpdateCardioDetailsCommand command, CancellationToken cancellationToken)
        {

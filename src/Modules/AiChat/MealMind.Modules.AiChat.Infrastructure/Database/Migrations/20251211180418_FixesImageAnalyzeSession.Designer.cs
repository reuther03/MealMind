...
namespace MealMind.Modules.AiChat.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251211180418_FixesImageAnalyzeSession")]
    partial class FixesImageAnalyzeSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MealMind.Modules.AiChat.Domain.ImageAnalyze.ImageAnalyze", b =>
                {
                    ...
                    b.Property<Guid?>("ImageAnalyzeSessionId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ImageAnalyzeSessionId1")
                        .IsUnique();
            ...
            modelBuilder.Entity("MealMind.Modules.AiChat.Domain.ImageAnalyze.ImageAnalyze", b =>
                {
                    ...
                    b.HasOne("MealMind.Modules.AiChat.Domain.ImageAnalyze.ImageAnalyzeSession", null)
                        .WithOne("ImageAnalyze")
                        .HasForeignKey("MealMind.Modules.AiChat.Domain.ImageAnalyze.ImageAnalyze", "ImageAnalyzeSessionId1");
                });

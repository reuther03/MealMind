...
public record GetChatResponse2Command(Guid ConversationId, string Prompt) : ICommand<StructuredResponse>
{
    public sealed class Handler : ICommandHandler<GetChatResponse2Command, StructuredResponse>
    {
        ...
        public async Task<Result<StructuredResponse>> Handle(GetChatResponse2Command request, CancellationToken cancellationToken)
        {

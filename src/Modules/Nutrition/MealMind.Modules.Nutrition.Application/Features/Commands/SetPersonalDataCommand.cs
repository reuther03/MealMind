...
//
// public record SetPersonalDataCommand(Gender Gender, DateOnly DateOfBirth, decimal Weight, decimal Height, ActivityLevel ActivityLevel) : ICommand<bool>
// {
...
//
//             var personalData = PersonalData.Create(command.Gender, command.DateOfBirth, command.Weight, command.Height, command.ActivityLevel);
